...
class CombatManager:
    ...
    def in_combat(self) -> bool:
        return self.state["combat"]["currently_in_combat"]

    def combatants(self) -> List[str]:
        return self.state["combat"]["combatants"]

    def enter_combat(self, combatants) -> Annotated[SaveResult, "save_result"]:
        self.state["combat"] = {"currently_in_combat": True, "combatants": combatants}
        return self.state_manager.save()

    def exit_combat(self, combatants) -> Annotated[SaveResult, "save_result"]:
        self.state["combat"] = {"currently_in_combat": False, "combatants": []}
        return self.state_manager.save()
